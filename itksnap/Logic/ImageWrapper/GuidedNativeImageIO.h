...
public:
  ...
  /**
   * Set an override for the component type used when creating wrappers.
   * When set, GetEffectiveComponentType() returns this instead of the native type.
   */
  void SetComponentTypeOverride(itk::IOComponentEnum ct)
    { m_ComponentTypeOverride = ct; }

  /**
   * Get the effective component type: returns the override if set, else native type.
   */
  itk::IOComponentEnum GetEffectiveComponentType() const
    { return m_ComponentTypeOverride != itk::IOComponentEnum::UNKNOWNCOMPONENTTYPE
        ? m_ComponentTypeOverride : m_NativeType; }
...
protected:
  ...
  /** Override for component type (UNKNOWNCOMPONENTTYPE means no override) */
  itk::IOComponentEnum m_ComponentTypeOverride = itk::IOComponentEnum::UNKNOWNCOMPONENTTYPE;
